<div class="space-y-4">
    ...
    <x-ui.card>
        <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4 justify-between">
            <h2 class=" text-xl font-bold text-gray-900 dark:text-white">Tambah lokasi baru</h2>
        ...
        <form wire:submit.prevent="save" class="grid gap-4">
            <div class="w-full lg:w-2xl">
                <x-ui.label for="name">Nama Lokasi</x-ui.label>
                <x-ui.input type="text" name="name" id="name" wire:model.defer="name" class="w-full" placeholder="Gudang A" required="" />
