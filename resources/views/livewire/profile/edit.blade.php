<div class="space-y-4">
    ...
    <x-ui.card>
        ...
        <form wire:submit.prevent="updateProfile" class="grid gap-4">
            ...
            <div class="w-full lg:w-2xl">
                ...
                <x-ui.input type="password" name="password" id="password" wire:model.defer="password" class="w-full" placeholder="••••••••" />
            ...
            <div class="w-full lg:w-2xl">
                ...
                <x-ui.input type="password" name="password_confirmation" id="password_confirmation" wire:model.defer="password_confirmation" class="w-full" placeholder="••••••••" />
            ...
            <div class="w-sm">
                <x-ui.button type="submit" wire:loading.attr="disabled" wire:target="updateProfile" class="flex items-center justify-center px-4 py-2.5 bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
